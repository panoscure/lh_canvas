...
class Register:
    ...
    def setUp(self, link):
        ...
        self.driver = webdriver.Chrome(
            r"C:\Users\maurogiannopoulos\PycharmProjects\pythonProjectTest\Browsers\chromedriver.exe")
    ...
    def bit8_change_name(self, bit8_user, bit8_password):
        ...
        WebDriverWait(self.driver, 20).until(
            EC.element_to_be_clickable((By.CSS_SELECTOR,
                                        "#page_players_player_info > div:nth-child(29) > div.ui-dialog-buttonpane.ui-widget-content.ui-helper-clearfix > div > button:nth-child(1)"))).click()
        time.sleep(2.5)
        ...
        try:
            self.driver.find_element_by_class_name("player_manage_btn")
